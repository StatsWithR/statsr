#' Confidence interval for a single mean, using simulation
#' @param y Numerical vector
#' @param conf_level Confidence level desired (between 0 and 1)
#' @param y_name Name of the y variable, to be used in output and plot axes
